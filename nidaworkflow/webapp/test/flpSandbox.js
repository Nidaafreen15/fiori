		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nidaapplicationnidaworkflow-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nidaapplicationnidaworkflow-display": {
								"semanticObject": "nidaapplicationnidaworkflow",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nidaapplication.nidaworkflow",
									"url": sap.ui.require.toUrl("nidaapplication/nidaworkflow")
								}
							}
						}
					}
